...
def update_E(E, H, P, P_prev, medium_mask):
	for position in range(1, E.shape[0], 1):
		...
		#E[int(E.shape[0]/2)] += 1e10*np.exp(-(timestep)**2 /(1e-16)**2.)
		return E

@nb.jit(nopython=True)
def update_N(N0, N1, N2, N3, medium_mask):
	for position in range(1, E.shape[0], 1):
		#if medium_mask[position] == 1:
...
for timestep in range(250000):
	...
	N0, N1, N2, N3 = update_N(N0, N1, N2, N3, medium_mask)
