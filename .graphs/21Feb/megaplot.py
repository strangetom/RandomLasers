...
ax2 = ax[1,1].twinx()
ax2.plot(time, N2x2[:,10],color=tableau20[0])
ax2.set_yticklabels(())
ax2.set_ylim(0,0.8)
...
ax2 = ax[1,2].twinx()
ax2.plot(time, N3x2[:,12],color=tableau20[0])
...
ax2 = ax[2,1].twinx()
ax2.plot(time, N2x1[:,12],color=tableau20[0])
ax2.set_yticklabels(())
ax2.set_ylim(0,0.6)
...
ax2 = ax[2,2].twinx()
ax2.plot(time, N3x1[:,12],color=tableau20[0])
