...
ax[1,0].set_yticklabels(np.arange(0,8+1,2))
ax2 = ax[1,0].twinx()
...
ax[1,1].set_yticklabels(np.arange(0,8+1,2))
...
ax[1,2].set_yticklabels(np.arange(0,8+1,2))
...
ax[2,0].set_yticklabels(np.arange(0,4+1,1))
ax2 = ax[2,0].twinx()
...
ax[2,1].set_yticklabels(np.arange(0,4+1,1))
...
ax[2,2].set_yticklabels(np.arange(0,4+1,1))
