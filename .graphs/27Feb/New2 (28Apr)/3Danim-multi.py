...
figtext = fig.text(0.42, 0.95, "", fontsize=28)
...
def update(i, ax1, ax2, fig):
	...
	ax1.set_zlabel('Excitation level', fontsize=18)
	...
	ax1.set_title("Population", fontsize=22)
	...
	ax2.set_zlabel('Energy density', fontsize=18)
	...
	ax2.set_title("Amplified Spontaneous Emission", fontsize=22)
