...
medium = np.loadtxt('./Data/Medium_10000dt_1000dx.txt', delimiter=',')
E_storage = np.loadtxt('./Data/E_storage_10000dt_1000dx.txt', delimiter=',')
...
fig.savefig('static_10000dt.png')
#plt.show()
