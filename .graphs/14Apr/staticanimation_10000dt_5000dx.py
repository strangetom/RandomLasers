...
medium = np.loadtxt('./Data/Medium_10000dt_5000dx.txt', delimiter=',')
E_storage = np.loadtxt('./Data/E_storage_10000dt_5000dx.txt', delimiter=',')
...
ax[0].plot(space/1e-6, E_storage[4], color=tableau20[6])
...
ax[1].plot(space/1e-6, E_storage[15], color=tableau20[6])
...
ax[1].set_xlim((0, 4.5))
ax[1].set_ylabel('0.5 fs', rotation=0, fontsize=15)
ax[1].yaxis.set_label_coords(-0.065, 0.5)

ax[2].plot(space/1e-6, E_storage[45], color=tableau20[6])
...
ax[2].set_xlim((0, 4.5))
ax[2].set_ylabel('1.5 fs', rotation=0, fontsize=15)
ax[2].yaxis.set_label_coords(-0.065, 0.5)

ax[3].plot(space/1e-6, E_storage[300], color=tableau20[6])
...
ax[3].set_xlim((0, 4.5))
ax[3].set_ylabel('10 fs', rotation=0, fontsize=15)
ax[3].yaxis.set_label_coords(-0.065, 0.5)

ax[4].plot(space/1e-6, E_storage[1000], color=tableau20[6])
